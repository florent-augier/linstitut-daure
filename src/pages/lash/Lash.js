  ...
  return (
    <div id="lash" className="page-container">
      ...
      <div id="container-show">
        <img
          src="https://res.cloudinary.com/flowww-dev/image/upload/v1647428756/L%27institut%20d%27Aur%C3%A9/Extension-de-cils_l0divs.webp"
          alt="technique d'extension de cils"
          width="960px"
          height="960px"
        />
        <div id="text-container-show">
          <p>Un visage à votre image. Frais et équilibré.</p>
          <ul>
            <li id="technique">
              <img
              ...
              />{" "}
              <span>
                Technique: <strong>Cil à cil</strong>
              </span>
            </li>
            <li id="duration">
              <img
              ...
              />{" "}
              <span>
                Durée initiale: <strong>1 heure 30 minutes</strong>
              </span>
            </li>
            <li id="cost">
              <img
              ...
              />
              <span>
                Prix de la prestation initiale: <strong>42 euros</strong>
              </span>
            </li>
          </ul>
        </div>
