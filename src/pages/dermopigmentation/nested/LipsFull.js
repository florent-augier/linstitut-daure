...
export default function LipsFull() {
  ...
  const container = {
    ...
    imageWidth: "1000px",
    imageHeight: "1000px",
    alt: "technique: Lèvres complet",
    content: "Pour avoir des lèvres parfaites.",
    technical: "Lèvres complet",
    duration: "2 Heures 30 Minutes",
    price: "220 euros",
  };
  return (
    <div id="lips-full" className="nested-container">
      <div id="nested-wrapper-header">
        <h2>Lèvres complet</h2>
      </div>
